            ...
            <div class="flex items-center justify-between h-14">
                ...
                <div class="hidden md:flex items-center gap-0.5">
                    <a href="<?= $base_url ?>/partials/dashboard.php"
                        class="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-md transition <?= $current_page === 'dashboard.php' ? 'bg-[var(--accent-light)] text-[var(--accent)]' : 'text-neutral-500 hover:text-neutral-300 hover:bg-white/[0.04]' ?>">
                    ...
                    <a href="<?= $base_url ?>/partials/results.php"
                        class="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-md transition <?= $current_page === 'results.php' ? 'bg-[var(--accent-light)] text-[var(--accent)]' : 'text-neutral-500 hover:text-neutral-300 hover:bg-white/[0.04]' ?>">
                        <svg class="w-3.5 h-3.5 icon-hover-scale" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Results
                    </a>
                    <a href="<?= $base_url ?>/partials/profile.php"
                        class="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-md transition <?= $current_page === 'profile.php' ? 'bg-[var(--accent-light)] text-[var(--accent)]' : 'text-neutral-500 hover:text-neutral-300 hover:bg-white/[0.04]' ?>">
                    ...
                    <a href="<?= $base_url ?>/admin/"
                        class="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-md transition <?= $current_dir === 'admin' ? 'bg-[var(--accent-light)] text-[var(--accent)]' : 'text-neutral-500 hover:text-neutral-300 hover:bg-white/[0.04]' ?>">
